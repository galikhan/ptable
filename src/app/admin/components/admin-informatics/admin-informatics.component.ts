...
@Component({
  selector: 'app-admin-informatics',
  standalone: true,
  imports: [CommonModule, FormsModule, MatButtonModule, MatIconModule, MatTreeModule, VideoPlayerComponent, MatTooltipModule, BrythonEditorComponent],
  templateUrl: './admin-informatics.component.html',
  styleUrl: './admin-informatics.component.scss'
})
export class AdminInformaticsComponent implements OnInit, AfterViewInit {
